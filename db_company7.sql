...
CREATE TABLE `pages_portfolio` (
  ...
  `youtube` varchar(225) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `instagram` varchar(225) COLLATE utf8mb4_general_ci NOT NULL,
  `facebook` varchar(225) COLLATE utf8mb4_general_ci NOT NULL
...
INSERT INTO `pages_portfolio` (`id`, `title`, `desk`, `images`, `id_projek`, `link`, `keyword`, `youtube`, `instagram`, `facebook`) VALUES
...
INSERT INTO `set_category` (`id`, `category`, `category_seo`) VALUES
(1, 'INTERIOR', 'interior'),
(2, 'TRALIS', 'tralis'),
...
--
-- Table structure for table `set_privacy`
--

CREATE TABLE `set_privacy` (
  `id` int NOT NULL,
  `title` varchar(221) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `body` longtext NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

--
-- Dumping data for table `set_privacy`
--

INSERT INTO `set_privacy` (`id`, `title`, `body`) VALUES
(1, 'Privacy And Policy', 'gsgegsegsegsgg');

-- --------------------------------------------------------

--
-- Table structure for table `set_terms`
--
...
--
-- Dumping data for table `set_terms`
--

INSERT INTO `set_terms` (`id`, `title`, `body`) VALUES
(1, 'KETENTUAN PENGGUNA', 'kakakkakakkkaka');
...
INSERT INTO `tbl_blog` (`id`, `title`, `body`, `meta_deskripsi`, `category`, `slug`, `private`, `foto`, `visitor`, `keyword`) VALUES
...
--
-- Table structure for table `tbl_custumer_email`
--

CREATE TABLE `tbl_custumer_email` (
  `id` int NOT NULL,
  `email` varchar(100) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

--
-- Dumping data for table `tbl_custumer_email`
--

INSERT INTO `tbl_custumer_email` (`id`, `email`) VALUES
(1, 'aisah@gmail.com');
...
INSERT INTO `tbl_message` (`id`, `name`, `email`, `subject`, `message`, `visit`, `date_send`) VALUES
(4, 'anam saepul', 'example@gmail.com', 'cdcdcdc', 'dcdcdc', 1, '2024-10-02 11:56:26'),
(5, 'ewc', 'aisah@gmail.com', 'Lorem ipsum dolor sit amet', 'ccfccf', 1, '2024-10-02 11:57:50'),
(6, 'wedcd', 'piansah009@gmail.com', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit.', 'dcsdcdsdcdsc', 1, '2024-10-02 11:58:59');
...
(6, 'CONTACT', 'Contack us Anugrah Alumunium', 'ini adalah kontak anugrah alumunium'),
(7, 'TERMS', 'Ketentuan Pengguna', 'sdsdsdsdd'),
(8, 'PRIVACY', 'ini adalah privacy', 'kalllalla');
...
INSERT INTO `tbl_service` (`id`, `title`, `body`, `images`, `private`, `slug`, `meta_deskripsi`, `keyword`) VALUES
...
INSERT INTO `tbl_testimoni` (`id`, `name`, `testimoni`, `category`, `foto`, `project`, `id_projek`) VALUES
(1, 'Customer Name', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus nec pretium mi. Curabitur', 'HOME', 'testimonial-1.jpg', 'slug-projek-1', 11),
(2, 'Customer Name', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus nec pretium mi. Curabitur\r\n                      ', 'PAGAR', 'testimonial-2.jpg', 'slug-projek-2', 12),
(3, 'Customer Name', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus nec pretium mi. Curabitur\r\n                   ', 'KANOPI', 'testimonial-3.jpg', 'slug-projek-3', 13),
(4, 'Customer Name', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus nec pretium mi. Curabit', 'INTERIOR', 'testimonial-4.jpg', 'slug-projek-4', 14);
...
INSERT INTO `users` (`id`, `nama`, `username`, `email`, `role`, `status`, `foto`, `nohp`, `password`) VALUES
(1, 'saepul anam', 'superadmin', 'kkskks@hhhhh.cd', 1, 1, 'logos.png', '087765655', '$2y$10$3.e6tTXe5ku4bqUR7cBwm.VFj83V3wRrAZT7OqIe0lWqGxJMgVDrG'),
(10, 'Mutiara Las', 'admin', 'lasekijaya@gmail.com', 2, 1, '', '86866433434', '$2y$10$afDk96oFFV9rfppGEZfm2O.UovB/GmKmQ/XI9PO7V3LdizXze/cQ.'),
(11, 'rusandi', 'rusandi', 'myinfo@konstruksi.com', 3, 1, '', '86866465665356', '$2y$10$HzK1UjU3STqda2f8KvFntOVUG1f9KfFW.IEsvH2lNuFVq1taeqioG');
...
--
-- Indexes for table `set_privacy`
--
ALTER TABLE `set_privacy`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `set_terms`
--
ALTER TABLE `set_terms`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `tbl_custumer_email`
--
ALTER TABLE `tbl_custumer_email`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `set_privacy`
--
ALTER TABLE `set_privacy`
  MODIFY `id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `set_terms`
--
ALTER TABLE `set_terms`
  MODIFY `id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
-- AUTO_INCREMENT for table `tbl_custumer_email`
--
ALTER TABLE `tbl_custumer_email`
  MODIFY `id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
