            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form id="form">
                                <input style="display: none;" type="text" name="id" value="<?= $field['id'] ?>">
                                <input style="display: none;" type="text" name="old_images"
                                    value="<?= $field['images'] ?>">
                                <div class="row">
                                    <div class="col-lg-8">
                                        <div class="card">
                                            <div class="card-body">
                                                <div class="form-group">
                                                    <textarea name="body" id="summernote"
                                                        ...
                                                        style="height:200px ;"><?= $field['body'] ?></textarea>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <textarea name="keyword" class="form-control form-control-sm"
                                                            id="smallInput"><?= $field['keyword'] ?></textarea>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <textarea name="meta_deskripsi"
                                                            ...
                                                            id="smallInput"><?= $field['meta_deskripsi'] ?></textarea>
                                                    </div>
                                                </div>
                                                <div class="mb-3 row">
                                                    <label for="staticEmail"
